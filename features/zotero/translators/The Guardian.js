{
	...
	"lastUpdated": "2014-02-24 20:04:08"
}
...
detect           : FW.Xpath('//div[contains(@id, "article")]/h1'),
title            : FW.Xpath('//div[contains(@id, "article")]/h1').text().trim(),
attachments      : [{ url: FW.Url(),
  title:  "Guardian Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//div[@class="contributor-full"]').text().remove(/\s(in|for)\s.+/).split(/\s*and\s*|\s*,\s*/).cleanAuthor("author"),
date             : FW.Xpath('//time[@itemprop="datePublished"]/@datetime').text(),
abstractNote	 : FW.Xpath('//div[@id="main-article-info"]/div[@id="stand-first"]').text().trim(),
tags			 : FW.Xpath('//meta[@property="article:tag"]/@content').text(),
...
var testCases = [
		...
		"items": [
			{
				...
				"url": "http://www.theguardian.com/world/2013/mar/05/hugo-chavez-dies-cuba",
				"abstractNote": "• Vice president Nicolas Maduro takes up interim post• Wave of mourning breaks out in streets of Venezuela• Chávez to get state funeral in Caracas",
				"date": "2013-03-05",
				"ISSN": "0261-3077",
				"language": "en-GB",
				"publicationTitle": "The Guardian",
		...
		"items": [
			{
				...
				"url": "http://www.theguardian.com/world/2013/mar/06/pentagon-iraqi-torture-centres-link",
				"abstractNote": "Exclusive: General David Petraeus and 'dirty wars' veteran behind commando units implicated in detainee abuse",
				"date": "2013-03-06T15:04EST",
				"ISSN": "0261-3077",
				"language": "en-GB",
				"publicationTitle": "The Guardian",
				"section": "World news",
	...
	{
		"type": "web",
		"url": "http://www.theguardian.com/world/2013/feb/26/football-heaven-god-play?INTCMP=SRCH",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
				...
				"url": "http://www.theguardian.com/world/2013/feb/26/football-heaven-god-play?INTCMP=SRCH",
				"abstractNote": "If there is, does God himself play? And if he does, what position?",
				"date": "2013-02-26T12:18EST",
				"ISSN": "0261-3077",
				"language": "en-GB",
				"publicationTitle": "The Guardian",
				"section": "World news",
