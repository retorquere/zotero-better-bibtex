{
	...
	"translatorType": 4,
	"browserSupport": "gcsb",
	"lastUpdated": "2014-04-05 23:54:59"
}
...
FW.Scraper({
itemType         : "blogPost",
detect           : FW.Xpath('//div[contains(@class,"permalink-tweet-container")]'),
attachments      : { url : FW.Url() ,
					 title : "Tweet Snapshot" ,
					 type : "text/html",
					 snapshot: true },
blogTitle		 : FW.Url().match(/([^\/]+)\/status\/\d+/,1).prepend("@"),
creators         : FW.Xpath('//div[contains(@class,"permalink-header")]//strong[contains(@class,"fullname")]')
						.text().cleanAuthor("author"),
// This part is fragile, since we have to iterate over the attributes
date         : FW.Xpath('//div[contains(@class,"permalink-tweet-container")]//span[@class="metadata"]/span[1]')
						.text(),
websiteType		 : "microblog",
title			 : FW.Xpath('//div[contains(@class,"permalink-tweet-container")]//p[contains(@class, "js-tweet-text")]').text(),
hooks            : {
		...
		"items": [
			{
				...
				"url": "https://twitter.com/zotero/status/105608278976905216",
				"blogTitle": "@zotero",
				"date": "Mon, 22 Aug 2011 04:52:00 GMT",
