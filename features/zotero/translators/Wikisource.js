{
	...
	"lastUpdated": "2013-04-22 21:02:52"
}
...
FW.Scraper({
itemType : 'manuscript',
detect : FW.Xpath('//div[@id="headertemplate"]'),
title : FW.Xpath('//div[@id="headertemplate"]//span[@id="header_title_text"]').text().trim().remove(/\n.+/g),
attachments : [{
  url : FW.Url(),
...
creators : FW.Xpath('//td[@class="gen_header_title"]//a[contains(@title, "Author")]').text().remove(/\n/g).remove(/\(.+/).cleanAuthor("author"),
abstractNote : FW.Xpath('//table[@class="header_notes"]').text().trim().remove(/\n\n+.+/g),
...
var testCases = [
	{
		"type": "web",
		"url": "https://en.wikisource.org/w/index.php?search=labour&title=Special%3ASearch",
		"items": "multiple"
	},
	{
		"type": "web",
