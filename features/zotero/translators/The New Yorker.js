{
	...
	"lastUpdated": "2012-09-24 18:13:02"
}
...
detect : FW.Xpath('//div[@id="articleheads"]'),
title : FW.Xpath('//div[@id="articleheads"]/h1').text().trim(),
attachments:  [{ url: FW.Url().append('?printable=true'),
					type : "text/html",
					title : "The New Yorker"}],
 abstractNote: FW.Xpath('//div[@id="articleheads"]/h2').text().trim(),
creators : FW.Xpath('//div[@id="articleheads"]/h4/span[@class="c cs"]/a').text().cleanAuthor("author"),
date : FW.Xpath('//div[@id="articleheads"]/h4/span[@class="dd dds"]').text().trimInternal(),
publicationTitle : "The New Yorker",
ISSN: "0028-792X",
tags: FW.Xpath('//div[@id="keywords"]').text().trimInternal().remove(/Keywords?\s*/).split(/;\s*/)
});

 /** Blog Posts */
 FW.Scraper({
itemType : 'blogPost',
detect : FW.Url().match(/\/blogs\/[^?#]+\.html/),
title : FW.Xpath('//h1[@class="entry-title"]').text().trim(),
attachments:  [{ url: FW.Url().append('?printable=true'),
					type : "text/html",
					title : "The New Yorker"}],
creators : FW.Xpath('//cite[@class="vcard author"]').text().cleanAuthor("author"),
date : FW.Xpath('//div[@id="pagebody"]/*/div[@class="published"]').text(),
publicationTitle : "The New Yorker Blogs",
tags: FW.Xpath('//div[@class="entry-keywords"]/ul').text().trimInternal().remove(/Keywords?\s*/).split(/;\s*/)
});
...
/** Search results */
 FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//div[@class="results"]'),
choices : {titles : FW.Xpath('//div[@class="info"]/h3[@class="header"]/a').text(),
urls : FW.Xpath('//div[@class="info"]/h3[@class="header"]/a').key('href').text() }
});
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.newyorker.com/talk/comment/2011/10/31/111031taco_talk_remnick",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.newyorker.com/online/blogs/hendrikhertzberg/2012/02/santorum-theology.html",
		"items": [
			{
				"itemType": "blogPost",
				"creators": [
	...
	{
		"type": "web",
		"url": "http://www.newyorker.com/search?qt=dismax&sort=score+desc&query=labor&submit=",
		"items": "multiple"
	}
]
/** END TEST CASES **/