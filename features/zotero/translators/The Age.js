{
	"translatorID": "f94bad2d-0c76-4e8f-a0d3-970810093c6c",
	"label": "The Age",
	"creator": "Justin Warren",
	"target": "^https?://www\\.theage\\.com\\.au/",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
...
detect		: FW.Xpath('//div[@id="content" and @class="span-16 article"]'),
title		: FW.Xpath('//head/title').text().trim(),
attachments : [ {url: FW.Xpath('//li[@class="print"]/a').key("href"),
  title: "The Age Printable",
  type:  "text/html",
}],

date		: FW.Xpath('//time').text().trim(),
creators	: FW.Xpath('//h3[@class="authorName"]').text().cleanAuthor(),
...
FW.MultiScraper({
itemType	: 'multiple',
detect		: FW.Xpath('//head/title[. = "Search Results"]'),
choices		: {
	titles	: FW.Xpath('//div[@class="cT-searchResult cfix"]/h3').text().trim(),
	urls	: FW.Xpath('//div[@class="cT-searchResult cfix"]/h3/a').key("href"),
}
})/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.theage.com.au/national/torture-for-fun-police-given-shocking-abattoir-footage-20130321-2ggm2.html",
		"items": [
			{
				"itemType": "newspaperArticle",
				"creators": [
				...
				"date": "March 21, 2013",
				"publicationTitle": "The Age",
				"title": "Inghams Turkey Cruelty Footage Shocks Animal Liberation",
	...
	{
		"type": "web",
		"url": "http://www.theage.com.au/execute_search.html?text=turkey&ss=Business",
		"items": "multiple"
	}
]
/** END TEST CASES **/