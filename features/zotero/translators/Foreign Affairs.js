{
	...
	"lastUpdated": "2013-09-22 22:49:29"
}
...
detect           : FW.Xpath('//meta[@name="articletype"]'),
title            : FW.Xpath('//meta[@name="title"]/@content').text().trim(),
attachments      : [{ 
  url: FW.Xpath('//a[contains(@class, "article_print") or contains(@class, "addthis_print")]/@href').text().prepend("www.foreignaffairs.com"),
...
date             : FW.Xpath('//meta[@name="issuedate"]/@content').text(),
abstractNote     : FW.Xpath('//meta[@property="og:description"]/@content').text(),
ISSN			 : "0015-7120",
issue			 : FW.Xpath('//div[contains(@class, "article-field-issue")]/a').text().remove(/Issue/).trim(),
tags            : FW.Xpath('//meta[@name="keyword"]/@content').text().trim(),
...
choices          : {
  titles :  FW.Xpath('//li[@class="first"]/div/a').text().trim(),
  urls    :  FW.Xpath('//li[@class="first"]/div/a').key("href")
}
});
...
choices          : {
  titles :  FW.Xpath('//div[@class="views-field-title"]/span[@class="field-content"]/a').text().trim(),
  urls    :  FW.Xpath('//div[@class="views-field-title"]/span[@class="field-content"]/a').key("href")
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
	...
	{
		"type": "web",
		"url": "http://www.foreignaffairs.com/articles/136917/matthew-kroenig/time-to-attack-iran",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
				...
				"attachments": [
					{
						"url": "www.foreignaffairs.com/print/134050",
						"title": "Foreign Affairs Printable",
						"type": "text/html"
					},
					{
