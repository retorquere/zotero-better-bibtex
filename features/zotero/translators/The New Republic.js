{
	"translatorID": "1bfb4748-3925-4de6-bcb4-5de2967f6d3f",
	...
	"lastUpdated": "2014-06-11 22:48:38"
}
...
detect : FW.Xpath('//h1[@class="title"]/span[@class="headline"]'),
title : FW.Xpath('//h1[@class="title"]/span[@class="headline"]').text().trim(),
attachments : {
  url : FW.Url(),
		...
		"items": [
			{
				...
				"ISSN": "0028-6583",
				"publicationTitle": "The New Republic",
				"title": "The Terrifying Rise of Greece’s Nazi Party",
