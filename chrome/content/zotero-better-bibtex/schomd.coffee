...
Zotero.BetterBibTeX.schomd.jsonrpc_bibliography = (citekeys, {format, style, libraryID} = {}) ->
  ...
  switch format
    ...
    when 'yaml'
      ...
      return Zotero.BetterBibTeX.translate(Zotero.BetterBibTeX.getTranslator('bettercslyaml'), {items}, {})
...
Zotero.BetterBibTeX.schomd.jsonrpc_bibtex = (keys, {translator, libraryID, displayOptions} = {}) ->
  ...
  return Zotero.BetterBibTeX.translate(Zotero.BetterBibTeX.getTranslator(translator), {items}, displayOptions)
