...
Update cache default: When items change
...
Options:
When exporting When items change`,description:`The Better BibTeX Configuration can be found under the regular Zotero preferences pane, tab ‘Better BibTeX’.
The configuration of Better BibTeX is a little baroque compared to the standard Zotero Bib(La)TeX exporters (which only have hidden preferences). The defaults should just work, but here’s an attempt to describe what they do.
...
Options:
No Assume single-word fields to be @string vars Match against the @string declarations below Match against the @string declarations and their values below Performance Collect performance information during startup default: no
Collect performance information during startup, to help diagnose slow starts. Always on for non-release builds.
Collect performance information while Zotero is running default: No
...
Options:
No Yes Yes, except during sync`,description:`The Better BibTeX Configuration can be found under the regular Zotero preferences pane, tab ‘Better BibTeX’.
The configuration of Better BibTeX is a little baroque compared to the standard Zotero Bib(La)TeX exporters (which only have hidden preferences). The defaults should just work, but here’s an attempt to describe what they do.
