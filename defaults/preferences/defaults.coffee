...
pref('extensions.zotero.translators.better-bibtex.citekeyFormat', '[auth:lower][Title:alphanum:fold:nopunct:skipwords:select,1,1:lower:prefix,_][year:prefix,_][0]')
