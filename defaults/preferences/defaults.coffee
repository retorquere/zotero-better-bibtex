...
pref('extensions.zotero.translators.better-bibtex.citekeyFormat', '[auth:fold:lower]_[Title:fold:nopunct:skipwords:select,1,1:lower]_[year]')
...
pref('extensions.zotero.translators.better-bibtex.collectednotes.format', 'html')
