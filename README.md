...
After installation, the plugin will auto-update to newer releases. Install by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/raw/master/zotero-better-bibtex-0.6.9.xpi) (**0.6.9**,
released on 2014-08-15 22:49). If you are not prompted with a Firefox installation dialog then double-click the
