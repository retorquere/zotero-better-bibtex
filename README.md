...
Install by downloading the [latest version](https://raw.github.com/friflaj/zotero-better-bibtex/master/zotero-better-bibtex-0.0.47.xpi).
...
or support requests on anything but the latest version, currently at **0.0.47**. If you submit an issue report,
