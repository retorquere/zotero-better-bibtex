...
version](https://zotplus.github.io/better-bibtex/zotero-better-bibtex-0.8.16.xpi)
(**0.8.16**).
...
<script type="text/javascript">
  ...
  if (window.location.hash.trim() == '#xpi') {
    window.location = 'https://zotplus.github.io/better-bibtex/zotero-better-bibtex-0.8.16.xpi';
  }
