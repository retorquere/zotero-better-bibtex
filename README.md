...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.2.16/zotero-better-bibtex-1.2.16.xpi)
(**1.2.16**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.2.16/zotero-better-bibtex-1.2.16.xpi';
      break;
    case '#debug':
