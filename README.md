...
After installation, the plugin will auto-update to newer releases. Install by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/raw/master/zotero-better-bibtex-0.5.44.xpi) (**0.5.44**,
released on 2014-07-03 11:06). If you are not prompted with a Firefox installation dialog then double-click the
