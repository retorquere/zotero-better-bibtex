...
version](https://raw.github.com/ReichenHack/zotero-better-bibtex/master/zotero-better-bibtex-0.5.9.xpi) (**0.5.9**, released
on 2014-05-14 10:06). If you are not prompted with a Firefox installation dialog then double-click the downloaded xpi; Firefox ought to start and present you with the installation dialog.
...
or support requests on anything but the latest version, currently at **0.5.9**.

If you submit an issue report,

* Please make *sure* you are on the latest version **0.5.9**. Auto-update will usually take care of it.
