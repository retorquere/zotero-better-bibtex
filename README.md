...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.4/zotero-better-bibtex-1.4.4.xpi)
(**1.4.4**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.4/zotero-better-bibtex-1.4.4.xpi';
      break;
    case '#debug':
