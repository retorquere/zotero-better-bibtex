...
Start by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.5.4/zotero-better-bibtex-1.5.4.xpi) (**1.5.4**), and then
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.5.4/zotero-better-bibtex-1.5.4.xpi';
      break;
    case '#debug':
