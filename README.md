...
version](https://raw.github.com/friflaj/zotero-better-bibtex/master/zotero-better-bibtex-0.1.39.xpi) (**0.1.39**, released
on 2014-03-05 09:19). If you are not prompted with a Firefox installation dialog then double-click the downloaded xpi; Firefox ought to start and present you with the installation dialog.
...
or support requests on anything but the latest version, currently at **0.1.39**. If you submit an issue report,
