...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.0/zotero-better-bibtex-1.4.0.xpi)
(**1.4.0**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.0/zotero-better-bibtex-1.4.0.xpi';
      break;
    case '#debug':
