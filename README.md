...
Start by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.6.5/zotero-better-bibtex-1.6.5.xpi) (**1.6.5**), and then
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.6.5/zotero-better-bibtex-1.6.5.xpi';
      break;
    case '#debug':
