...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/0.8.37/zotero-better-bibtex-0.8.37.xpi)
(**0.8.37**).
...
<script type="text/javascript">
  ...
  if (window.location.hash.trim() == '#xpi') {
    window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/0.8.37/zotero-better-bibtex-0.8.37.xpi';
  }
