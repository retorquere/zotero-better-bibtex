...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.2.3/zotero-better-bibtex-1.2.3.xpi)
(**1.2.3**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.2.3/zotero-better-bibtex-1.2.3.xpi';
      break;
    case '#debug':
