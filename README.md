...
version](https://raw.github.com/ReichenHack/zotero-better-bibtex/master/zotero-better-bibtex-0.3.10.xpi) (**0.3.10**, released
on 2014-04-28 16:05). If you are not prompted with a Firefox installation dialog then double-click the downloaded xpi; Firefox ought to start and present you with the installation dialog.
...
or support requests on anything but the latest version, currently at **0.3.10**. If you submit an issue report,
