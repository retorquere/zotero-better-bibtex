...
Start by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.6.27/zotero-better-bibtex-1.6.27.xpi) (**1.6.27**), and then
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.6.27/zotero-better-bibtex-1.6.27.xpi';
      break;
    case '#debug':
