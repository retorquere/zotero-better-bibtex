...
After installation, the plugin will auto-update to newer releases. Install by downloading the [latest version](https://github.com/ZotPlus/zotero-better-bibtex/raw/master/zotero-better-bibtex-0.5.40.xpi) (**0.5.40**,
released on 2014-06-25 01:03). If you are not prompted with a Firefox installation dialog then double-click the
