...
version](https://zotplus.github.io/better-bibtex/zotero-better-bibtex-0.8.18.xpi)
(**0.8.18**).
...
<script type="text/javascript">
  ...
  if (window.location.hash.trim() == '#xpi') {
    window.location = 'https://zotplus.github.io/better-bibtex/zotero-better-bibtex-0.8.18.xpi';
  }
