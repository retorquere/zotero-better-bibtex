...
* Set your own, fixated [Citation Keys](https://retorquere.github.io/zotero-better-bibtex/citing), generate citation keys from [JabRef patterns](https://help.jabref.org/en/BibtexKeyPatterns), drag and drop LaTeX citations, add other custom BibLaTeX fields.
* Highly [Customized Exports](https://retorquere.github.io/zotero-better-bibtex/exporting).
