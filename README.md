...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.5/zotero-better-bibtex-1.4.5.xpi)
(**1.4.5**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.5/zotero-better-bibtex-1.4.5.xpi';
      break;
    case '#debug':
