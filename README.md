...
version](https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.2/zotero-better-bibtex-1.4.2.xpi)
(**1.4.2**).
...
<script type="text/javascript">
  ...
  switch (window.location.hash.trim()) {
    case '#xpi':
      window.location = 'https://github.com/ZotPlus/zotero-better-bibtex/releases/download/1.4.2/zotero-better-bibtex-1.4.2.xpi';
      break;
    case '#debug':
