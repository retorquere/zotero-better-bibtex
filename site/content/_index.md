...
* Stable [Citation Keys]({{< ref "citation-keys" >}}, without key clashes! Generates citation keys that take into account other existing keys in your library
...
* Set your own, fixed [Citation Keys]({{< ref "citation-keys" >}}, generate citation keys from [JabRef patterns](https://help.jabref.org/en/BibtexKeyPatterns), drag and drop LaTeX citations, add other custom BibLaTeX fields.
...
* Automatic [journal abbreviation]({{< ref "citation-keys" >}}.
