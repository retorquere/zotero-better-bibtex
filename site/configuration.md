...
### Force citation key to ASCII <!-- extensions.zotero.translators.better-bibtex.citekeyFold -->
...
### Add URLs to BibTeX export <!-- extensions.zotero.translators.better-bibtex.bibtexURLs -->
...
### Auto-pin citation keys <!-- extensions.zotero.translators.better-bibtex.pinCitekeys -->
...
### Key conflict policy ("On conflict, non-pinned key should be...") <!-- extensions.zotero.translators.better-bibtex.keyConflictPolicy -->
...
### Show citekey in reference list <!-- extensions.zotero.translators.better-bibtex.showCitekeys -->
...
### Move name-particles (de, von, ...) to the family name <!-- extensions.zotero.translators.better-bibtex.parseParticles -->
...
### Fields to omit from export <!-- extensions.zotero.translators.better-bibtex.skipFields -->

If there are some fields you don't want in your bibtex files (such as `note` for example), add a list of them here,
separated by comma's.

### Export BibTeX as ASCII <!-- extensions.zotero.translators.better-bibtex.asciiBibTeX -->
...
### Export BibLaTeX as ASCII <!-- extensions.zotero.translators.better-bibtex.asciiBibLaTeX -->
...
### When a reference has both a DOI and an URL, ... <!-- extensions.zotero.translators.better-bibtex.DOIandURL -->
...
### Preserve BibTeX variables <!-- extensions.zotero.translators.better-bibtex.preserveBibTeXVariables -->
...
### Export collections recursively <!-- extensions.zotero.recursiveCollections -->
...
### Enable export by HTTP <!-- extensions.zotero.httpServer.enabled -->
...
### Retain LaTeX markup on BibTeX import <!-- extensions.zotero.translators.better-bibtex.rawImports -->
...
### Automatically abbreviate journal titles <!-- extensions.zotero.translators.better-bibtex.autoAbbrev -->
...
### Abbreviation style <!-- extensions.zotero.translators.better-bibtex.autoAbbrevStyle -->

Select the style for auto-abbreviation.

# Automatic Export

### Automatic Export <!-- extensions.zotero.translators.better-bibtex.autoExport -->
...
### Extended debug logging <!-- extensions.zotero.translators.better-bibtex.debug -->
...
### Show reference ID <!-- extensions.zotero.translators.better-bibtex.showItemIDs -->
...
### Re-scan pinned citekeys <!-- extensions.zotero.translators.better-bibtex.scanCitekeys -->
...
### confirmCacheResetSize <!-- extensions.zotero.translators.better-bibtex.confirmCacheResetSize -->
...
### caching <!-- extensions.zotero.translators.better-bibtex.caching -->
...
### csquotes <!-- extensions.zotero.translators.better-bibtex.csquotes -->

Enables [csquotes](unicode.html) support.

### langID <!-- extensions.zotero.translators.better-bibtex.langID -->

Switches between `babel` and `polyglossia`, except I haven't gotten around to polyglossia yet.

### skipWords <!-- extensions.zotero.translators.better-bibtex.skipWords -->

list of words to skip in title when generating citation keys

### tests <!-- extensions.zotero.translators.better-bibtex.tests -->

Unit tests to run 

### postscript <!-- extensions.zotero.translators.better-bibtex.postscript -->

Snippet of javascript to run [after each BibTeX generation](export.html).

### jabrefGroups <!-- extensions.zotero.translators.better-bibtex.jabrefGroups -->

Export JabRef groups for collections.

### defaultDateParserLocale <!-- extensions.zotero.translators.better-bibtex.defaultDateParserLocale -->
...
### titleCase <!-- extensions.zotero.translators.better-bibtex.titleCase -->

Automatically titlecase English titles on export

### titleCaseLowerCase <!-- extensions.zotero.translators.better-bibtex.titleCaseLowerCase -->

List of words to keep lowercase when applying title casing

### titleCaseUpperCase <!-- extensions.zotero.translators.better-bibtex.titleCaseUpperCase -->
