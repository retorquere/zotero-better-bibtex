...
if (Zotero.Debug.enabled) {
  for (const event of [ 'empty', 'drain', 'task_queued', 'task_accepted', 'task_started', 'task_finish', 'task_failed', 'task_progress', 'batch_finish', 'batch_failed', 'batch_progress' ]) {
    (e => scheduler.on(e, () => { debug(`AutoExport.scheduler.${e}`, Array.prototype.slice.call(arguments)); }))(event);
    (e => scheduled.on(e, () => { debug(`AutoExport.scheduled.${e}`, Array.prototype.slice.call(arguments)); }))(event);
  }
}
