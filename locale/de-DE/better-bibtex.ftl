...
better-bibtex_error-report_review = Die unten aufgeführten Daten werden für die Fehlerbehebung an Better BibTeX gesendet. Bitte prüfen Sie sie auf sensible Daten, die sie nicht senden wollen.
...
better-bibtex_preferences_advanced_import_case-protection_warning = Beim Import fügt BBT den Titeln, die Wörter in {"{"}Braces{"}"}haben, den Groß-/Kleinschreibung (<span class="nocase">...<span>) hinzu.
...
better-bibtex_preferences_advanced_import_sentence-case_warning = Bib(La)TeX-Einträge müssen im Titelfall gespeichert werden; Zotero-Einträge werden als Sätze erwartet.
...
better-bibtex_preferences_export_fields_language_language = Sprache
...
better-bibtex_preferences_export_jabref-format_0 = Keine
...
unused_better-bibtex_db_corrupt_explanation = Beim Öffnen der Datenbank ist ein Fehler aufgetreten. Dies könnte bedeuten, dass Ihre Datenbank beschädigt ist. Der von Zotero gemeldete Fehler ist: { $error }.
...
unused_better-bibtex_preferences_advanced_tab_citekeys = Zitierschlüssel
...
unused_better-bibtex_preferences_citekey_citekeys = Zitierschlüssel
