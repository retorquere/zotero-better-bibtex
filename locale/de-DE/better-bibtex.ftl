...
better-bibtex_preferences_auto-export_status_preparing = Vorbereitung { $translator}
better-bibtex_preferences_auto-export_status_preparing_delayed = Vorbereitung { $translator }, { $pending } Exporte ausstehend
...
better-bibtex_preferences_citekey_auto-pin-delay = Zitierschlüssel automatisch ausfüllen nach
...
better-bibtex_preferences_citekey_dynamic = 
    .label = Zitierschlüssel bei Änderung des Elements neu generieren
better-bibtex_preferences_citekey_uniqueness = Halte Zitierschlüssel eindeutig
better-bibtex_preferences_citekey_uniqueness_case = 
    .label = Groß-/Kleinbuchstaben beim Vergleich mit Eindeutigkeit ignorieren
better-bibtex_preferences_citekey_uniqueness_conflict = Wenn ein Zitierschlüssel gesetzt ist, der bereits in anderen Elementen verwendet wird, werden die Schlüssel dieser anderen Elemente sein
better-bibtex_preferences_citekey_uniqueness_conflict_change = 
    .label = postfixed (führt zu Zitier Schlüssel Änderungen)
better-bibtex_preferences_citekey_uniqueness_conflict_keep = 
    .label = beibehalten (führt zu Duplikaten von Zitierschlüsseln)
...
better-bibtex_preferences_citekey_uniqueness_scope_global = 
    .label = über alle Bibliotheken hinweg
better-bibtex_preferences_citekey_uniqueness_scope_library = 
    .label = innerhalb jeder Bibliothek
