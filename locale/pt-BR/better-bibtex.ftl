...
better-bibtex_bulk-keys-confirm = 
  .value = Você está modificando mais que { $treshold } items de uma vez. Tem certeza?
  .buttonlabelextra1 = OK e não perguntar novamente
...
better-bibtex_first-run = 
  .title = Bem-vindo ao Better BibTeX para Zotero
  .label = Bem-vindo ao Better BibTeX para Zotero

better-bibtex_first-run_citekey-format = Suas chaves de citação
...
better-bibtex_first-run_citekey-format_explanation_example = suas chaves de citação serão como

better-bibtex_first-run_citekey-format_explanation_zotero = Escolha esta opção se você tiver documentos existentes que se referem a chaves geradas por Zotero sem a ajuda do BBT. Isso irá reproduzir fielmente as chaves geradas por Zotero, incluindo as limitações conhecidas do gerador de chaves do Zotero. Apenas use esta opção se precisar que as chaves sejam exatamente como geradas por Zotero.
better-bibtex_first-run_citekey-format_zotero = 
  .label = Use the Zotero default citekey format

better-bibtex_first-run_done = Tudo pronto!

better-bibtex_first-run_done_explanation = BBT já está configurado. Você ainda pode mudar qualquer uma dessas opções nas preferências do Zotero, abrindo a aba BBT.
better-bibtex_first-run_drag-and-drop = Arrastar-e-soltar citações
better-bibtex_first-run_drag-and-drop_enable = 
  .label = Ativar arrastar-e-soltar citações


better-bibtex_first-run_drag-and-drop_explanation = Com BBT, é possível arrastar e soltar citações no seu editor LaTeX preferido. Você quer ativar isso?
better-bibtex_first-run_exporting = Exportar usando BBT

better-bibtex_first-run_exporting_explanation = Exportar usando BBT funciona como sempre no Zotero, mas verifique que você escolheu o formato correto; na lista de formatos, ao invés de 'BibTeX', escolha
...
better-bibtex_first-run_welcome = Better BibTeX para Zotero (ou simplesmente BBT) procura tornar Zotero mais útil para tradicionalistas do LaTeX e do Markdown. Há muitas opções para configurar no BBT -- dê uma olhada nas preferências se estiver curioso -- mas vamos acertrar o básico com algumas escolhas simples.
...
better-bibtex_preferences_export_bibtex_urls_off = não
...
better-bibtex_preferences_export_jabref-format_0 = não
...
better-bibtex_preferences_tab_auto-export = 
  .label = Exportação automática

better-bibtex_preferences_tab_citekey = 
  .label = Chaves de citação
...
unused_better-bibtex_db_corrupt_explanation = Ocorreu um erro abrindo seu banco de dados. Isso pode significar que seu banco de dados está corrompido. O erro informado por Zotero foi: { $error }.
...
unused_better-bibtex_preferences_citekey_citekeys = Chaves de citação
