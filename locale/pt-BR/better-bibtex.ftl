better-bibtex = 
    .label = Better BibTeX
-citation-key = Chave de Referência
better-bibtex_auto-export_delete = Excluindo exportação automática
better-bibtex_auto-export_delete_confirm = Tem certeza que deseja excluir a exportação automática? Esta ação não pode ser desfeita.
better-bibtex_aux-scan_prompt = Nome da etiqueta
better-bibtex_aux-scan_title_aux = Etiquetar itens citados do arquivo AUX
better-bibtex_aux-scan_title_md = Etiquetar itens citados do arquivo Markdown
better-bibtex_aux-scanner = 
    .label = Examinar o arquivo BibTeX AUX/Markdown em busca de referências...
better-bibtex_aux-scanner_replace-collection = 
    .label = Examinar o arquivo BibTeX AUX/Markdown e substituir itens nesta coleção...
better-bibtex_bulk-keys-confirm_warning = Você está alterando mais que { $treshold } itens de uma só vez. Tem certeza?
better-bibtex_bulk-keys-confirm_stop_asking = OK e não me pergunte de novo
better-bibtex_error-report = 
    .title = Relatório de depuração Better BibTeX
better-bibtex_error-report_upgrade = A última versão { $program } é <strong>{ $upgrade }</strong>, você está executando <strong>{ $running }</strong>; por favor, atualize primeiro.
better-bibtex_error-report_upgrade_auto = { $program } irá atualizar no canal { $channel } a cada { $interval }, última atualização em { $lastUpdate }.
better-bibtex_error-report_upgrade_manual = { $program } atualizações estão desativadas
better-bibtex_error-report_no_items = Este relatório não incluirá itens de amostra. <b>Estes não são obrigatórios</b>, mas geralmente são necessários para criar casos de teste para a mudança/correção que você solicitar. Para gerar um relatório com itens de amostra:
better-bibtex_error-report_no_items_cancel = cancelar este assistente
better-bibtex_error-report_no_items_reproduce = reproduza o problema
better-bibtex_error-report_no_items_select = selecione a(s) referência(s) que exibe(m) o problema e clique com o botão direito
better-bibtex_error-report_no_items_popup = escolha <i>Better BibTeX</i> no menu pop-up
better-bibtex_error-report_no_items_report = escolha <i>{ better-bibtex_report-errors }</i>
better-bibtex_error-report_better-bibtex_cache = 
    .value = Tamanho do cache: { $entries } entradas.
better-bibtex_error-report_context = 
    .label = Contexto da aplicação
better-bibtex_error-report_debug = 
    .label = Relatório de depuração
