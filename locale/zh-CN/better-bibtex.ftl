...
better-bibtex_zotero-pane_citekey_pin_inspire-hep = 从 InspireHEP 设置 BibTeX 引用
better-bibtex_zotero-pane_citekey_refresh = 重新生成 BibTeX 引用
better-bibtex_zotero-pane_citekey_fill = 生成缺失的 BibTeX 引用
