...
better-bibtex_error-report_better-bibtex_latest = Better BibTeX 的最新版本为 { $version } —— 请先升级。
better-bibtex_error-report_better-bibtex_current_zotero = 目前运行的 Zotero 版本为 { $version }
better-bibtex_error-report_better-bibtex_latest_zotero = Zotero 的最新版本为 { $version } —— 请先升级。
