...
better-bibtex_preferences_export_sort_citekey = 引用关键词（对于非常大的文库较慢）
...
better-bibtex_preferences_export_quick-copy_citekeys = 引用关键词
...
better-bibtex_preferences_export_quick-copy_org-mode_cite = Org-mode 引用
...
better-bibtex_preferences_export_quick-copy_org-mode_citekey = 使用 Better BibTeX 引用关键词
...
better-bibtex_preferences_export_quick-copy_select-link_citekey = 使用 Better BibTeX 引用关键词
