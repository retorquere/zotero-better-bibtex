...
better-bibtex_error-report_post-to-github = 请在 GitHub Issue 上发布一条消息，内容包括此调试日志的 ID、问题描述，以及重现问题所需的步骤。 <strong>只有在 GitHub Issue 中引用了日志 ID，日志才会被查看。</strong><br>https://github.com/retorquere/zotero-better-bibtex/issues
