...
better-bibtex_error-report_better-bibtex_latest = La dernière version de Better BibTeX est { $version } -- veuillez d'abord mettre à jour.
better-bibtex_error-report_better-bibtex_current_zotero = Vous exécutez Zotero version { $version }
better-bibtex_error-report_better-bibtex_latest_zotero = La dernière version de Zotero est { $version } -- veuillez mettre à jour d'abord.
