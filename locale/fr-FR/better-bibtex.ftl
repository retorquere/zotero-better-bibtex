...
better-bibtex_error-report_upgrade = La dernière version { $program } est <strong>{ $upgrade }</strong>, vous utilisez <strong>{ $running }</strong> ; veuillez mettre à niveau d'abord.
better-bibtex_error-report_upgrade_auto = { $program } va mettre à jour depuis le canal { $channel } toutes les { $interval }, dernière mise à jour à { $lastUpdate }.
better-bibtex_error-report_upgrade_manual = Les mises à jour { $program } sont désactivées
better-bibtex_error-report_no_items = Ce journal n'inclura pas les éléments d'échantillon. <b>Ceux-ci ne sont pas obligatoires</b>, mais sont généralement nécessaires pour créer des cas de test pour le changement/correction que vous demanderez. Pour générer un journal avec des exemples d'éléments :
better-bibtex_error-report_no_items_cancel = annuler cet assistant
better-bibtex_error-report_no_items_reproduce = reproduire le problème
better-bibtex_error-report_no_items_select = sélectionnez la ou les références qui exposent le problème et cliquez avec le bouton droit de la souris
better-bibtex_error-report_no_items_popup = choisissez <i>Better BibTeX</i> dans le menu contextuel
better-bibtex_error-report_no_items_report = choisissez <i>{ better-bibtex_report-errors }</i>
better-bibtex_error-report_better-bibtex_cache = 
    .value = Taille du cache : { $entries } entrées.
better-bibtex_error-report_context = 
    .label = Contexte d'application
better-bibtex_error-report_debug = 
    .label = Journal de débogage
better-bibtex_error-report_enable-debug = La création de rapport d'erreurs de Zotero est actuellement désactivé. Il sera plus facile de diagnostiquer le problème si vous l'activez avant de soumettre un rapport d'erreur de Better BibTeX.
...
better-bibtex_error-report_items = 
    .label = Références
better-bibtex-error-send-reminder = Cliquer sur «{ $send }» enverra le journal de débogage pour que le développeur puisse l'examiner.
better-bibtex_error-report_post-to-github = Veuillez poster un message sur le traqueur de tickets avec cet ID de journal de débogage, une description du problème et toutes les étapes nécessaires pour le reproduire. <strong>Les journaux de débogage ne peuvent pas être examinés à moins d'être référencés dans le gestionnaire de tickets GitHub par leur ID.</strong>
...
better-bibtex_preferences_advanced_export_reset-cache = 
    .label = Le cache sera recréé au prochain démarrage
...
better-bibtex_preferences_advanced_ideographs_chinese = 
    .label = Activer les filtres 'jieba'/'pinyin' dans les motifs de clés de citation. Monopolise beaucoup de mémoire.
better-bibtex_preferences_advanced_ideographs_splitName = 
    .label = Séparer tous les noms à champ unique de type chinois, sauf si la langue de l'élément est le japonais et que la prise en charge du japonais est activée.
better-bibtex_preferences_advanced_ideographs_japanese = 
    .label = Appliquer la romanisation kuroshiro dans les noms/titres en japonais. Monopolise beaucoup de mémoire.
...
better-bibtex_preferences_citekey_dynamic = 
    .label = Régénérer la clé de citation lorsque l'élément change
...
better-bibtex_preferences_export_biblatex_use-prefix = 
    .label = ajouter un préfixe d'utilisation lorsque le nom de famille a un préfixe
...
better-bibtex_preferences_export_quick-copy_org-mode_cite = Lien de citation de org-mode
...
better-bibtex_preferences_rescan-citekeys = 
    .label = Scanner à nouveau les clés de citation
better-bibtex_preferences_reset-cache = 
    .label = Réinitialiser le cache au prochain démarrage
...
better-bibtex_zotero-pane_citekey_pin_inspire-hep = Définir la clé BibTeX depuis InspireHEP
better-bibtex_zotero-pane_citekey_refresh = Régénérer la clé BibTeX
better-bibtex_zotero-pane_citekey_fill = Générer une clé BibTeX manquante
