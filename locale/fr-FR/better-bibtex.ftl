...
better-bibtex_aux-scanner_replace-collection = 
    .label = Scanner le fichier BibTeX AUX/Markdown et remplacer les éléments de cette collection...
...
better-bibtex_preferences_advanced_extra-field_as-note = 
    .label = Traiter le champ `extra` comme une note
...
better-bibtex_preferences_auto-abbrev = Mode d'abréviation des journaux
better-bibtex_preferences_auto-abbrev_abbrev = 
    .label = toujours utiliser le champ d'abréviation de Zotero
better-bibtex_preferences_auto-abbrev_auto = 
    .label = toujours utiliser la valeur auto-abrégée
better-bibtex_preferences_auto-abbrev_abbrev-plus-auto = 
    .label = utiliser le champ d'abréviation Zotero, repli sur l'abréviation automatique
...
better-bibtex_preferences_auto-export_idle = 
    .label = Quand au ralenti
better-bibtex_preferences_auto-export_immediate = 
    .label = En cas de modification
...
better-bibtex_preferences_citekey_uniqueness = Garder les clés de citation uniques
...
better-bibtex_preferences_citekey_uniqueness_conflict_change = 
    .label = modifiées (cause des changements de clé)
better-bibtex_preferences_citekey_uniqueness_conflict_keep = 
    .label = conservées (risque de doublons)
...
better-bibtex_preferences_citekey_uniqueness_scope_global = 
    .label = à travers toutes les bibliothèques
better-bibtex_preferences_citekey_uniqueness_scope_library = 
    .label = à l'intérieur de chaque collection
...
better-bibtex_preferences_export_sort_off = 
    .label = éteint (plus rapide)
better-bibtex_preferences_export_sort_id = 
    .label = ordre de création d'élément (beaucoup plus rapide)
better-bibtex_preferences_export_sort_citekey = 
    .label = clé de citation (plus lente avec les très grandes bibliothèques)
...
better-bibtex_preferences_export_fields_export-strings_detect = 
    .label = Supposer que les champs à valeur unique sont des variables @string
better-bibtex_preferences_export_fields_export-strings_match = 
    .label = Comparer aux variables @string ci-dessous
better-bibtex_preferences_export_fields_export-strings_match_reverse = 
    .label = Comparer aux variables @string et leurs valeurs ci-dessous
...
better-bibtex_preferences_profiling_start = 
    .label = Capturer le profil de performance
better-bibtex_preferences_profiling_stop = 
    .label = Enregistrer le profil de performance
better-bibtex_preferences_tab_profiling = Mesure des performances
...
better-bibtex_report-errors = 
    .label = Envoyer le journal de débogage Better BibTeX...
...
better-bibtex_zotero-pane_citekey_move_from_extra = 
    .label = Déplacer la clé de référence du champ extra vers la clé de citation
better-bibtex_zotero-pane_citekey_clear_from_extra = 
    .label = Effacer la clé de citation du champ extra
...
better-bibtex_zotero-pane_tag_duplicates = 
    .label = Tagguer les clés de citation doublons
