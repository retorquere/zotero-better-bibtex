...
better-bibtex_error-report_post-to-github = Veuillez poster un message sur le traqueur de tickets avec cet ID de journal de débogage, une description du problème et toutes les étapes nécessaires pour le reproduire. <strong>Les journaux de débogage ne peuvent pas être revus à moins d'être référencés dans le gestionnaire de tickets GitHub par leur ID.</strong><br>https://github.com/retorquere/zotero-better-bibtex/issues
