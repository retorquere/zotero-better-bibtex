{
	...
	"lastUpdated": "2017-01-03 14:46:57"
}
...
detect : FW.Url().match(/\/view\/Entry\//),
title : FW.Xpath('//h1/span[@class="hwSect"]').text().trim(),
attachments : {
  url : FW.Url(),
  title : "OED snapshot",
  type : "text/html"
...
publicationTitle : "OED Online"
});

/** Search results */
FW.MultiScraper({
itemType : "multiple",
detect : FW.Url().match(/https?:\/\/www\.oed\.com\/search\?/),
choices : {
  titles : FW.Xpath('//div[@class="result"]/h2/span[@class="word"]/a').text(),
  urls : FW.Xpath('//div[@class="result"]/h2/span[@class="word"]/a').key('href').text()
}
});
