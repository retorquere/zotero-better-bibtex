...
FW.Scraper({
itemType : 'report',
detect : FW.Xpath('//h2[contains(text(), "Full Record")]'),
title : FW.Xpath('//tr/td[strong[contains(text(), "Title:")]]/following-sibling::td').text().replace(/\n/g, " ").trim(),
attachments : [{
  url : FW.Url(),
  title : "PolicyFile Record snapshot",
  type : "text/html"
},
{  url : FW.Xpath('//tr/td[strong[contains(text(), "URL:")]]/following-sibling::td').text().remove(/\[.+/).trim(),
  title : "FullText PDF via PolicyFile",
  type : "application/pdf"
}],
url : FW.Xpath('//tr/td[strong[contains(text(), "URL:")]]/following-sibling::td').text().remove(/\[.+/).trim(),
tags : FW.Xpath('//tr/td[strong[contains(text(), "Subject(s)")]]/following-sibling::td').text().split(/\s*;\s*/),
creators : FW.Xpath('//tr/td[strong[contains(text(), "Author(s):")]]/following-sibling::td').text().split(/\s*;\s*/).cleanAuthor("author", true),
abstractNote : FW.Xpath('//tr/td[strong[contains(text(), "Abstract:")]]/following-sibling::td').text().replace(/\n/g, " "),
date : FW.Xpath('//tr/td[strong[contains(text(), "date:")]]/following-sibling::td').text(),
reportType :  FW.Xpath('//tr/td[strong[contains(text(), "Publication number:")]]/following-sibling::td').text(),
language : FW.Xpath('//tr/td[strong[contains(text(), "language:")]]/following-sibling::td').text(),
publisher : FW.Xpath('//tr/td[strong[contains(text(), "Publishing body:")]]/following-sibling::td').text(),
});
...
choices : {
  titles : FW.Xpath('//div[@class="result"]/a').text(),
  urls : FW.Xpath('//div[@class="result"]/a').key('href').text()
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
		"type": "web",
		"url": "http://www.policyfile.com/fullrec/fullrecid.do?ItemID=00012801",
		"items": [
			{
				"itemType": "report",
				"creators": [
				...
				"abstractNote": "The new welfare law, the Personal Responsibility and Work Opportunity Reconciliation Act, represents a major step in welfare reform by promoting work-based programs, but there is still room to improve the law within the confines of the new political consensus that those who are on welfare need to be put on a path that takes them into the labor market and keeps them there. This will require a whole new way of thinking about welfare. To realize the goals of work and self-sufficiency involves no less than breaking down distinctions between welfare programs and other employment programs. It involves achieving a more coherent and comprehensive employment policy by merging existing welfare and employment bureaucracies.",
				"date": "August 1997",
				"language": "English",
				"publisher": "Levy Economics Institute",
				"reportType": "Public Policy Brief No. 31",
				"title": "A New Path from Welfare to Work",
				"libraryCatalog": "ProQuest PolicyFile"
			}
		]
	}
]
