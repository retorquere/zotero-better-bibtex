{
	...
	"lastUpdated": "2015-10-10 20:40:57"
}
...
detect : FW.Xpath('//hgroup[@id="masthead"]/h4[@class="rubric"]'),
title : FW.Xpath('//hgroup[@id="masthead"]/h1').text().trim(),
attachments:  [{ url: FW.Url(),
					type : "text/html",
					title : "The New Yorker"}],
abstractNote: FW.Xpath('//hgroup[@id="masthead"]/h2[@itemprop="alternativeHeadline"]').text().trim(),
creators : FW.Xpath('//hgroup[@id="masthead"]/h3/span[@itemprop="author"]').text().cleanAuthor("author"),
date : FW.Xpath('//hgroup[@id="masthead"]/h4[@class="rubric"]//span[@class="magazine-date"]').text().remove(/Issue/).trimInternal(),
publicationTitle : "The New Yorker",
ISSN: "0028-792X"
});

/** Articles (used to be blog)
Keeping these as magazineArticle, but not sure about category; not published in print*/
FW.Scraper({
itemType : 'magazineArticle',
detect : FW.Xpath('//hgroup[@id="masthead"]/span[contains(@class, "timestamp")]'),
title : FW.Xpath('//hgroup[@id="masthead"]/h1').text().trim(),
attachments:  [{ url: FW.Url(),
					type : "text/html",
					title : "The New Yorker"}],
abstractNote: FW.Xpath('//hgroup[@id="masthead"]/h2[@itemprop="alternativeHeadline"]').text().trim(),
creators : FW.Xpath('//hgroup[@id="masthead"]/h3/span[@itemprop="author"]').text().cleanAuthor("author"),
date : FW.Xpath('//hgroup[@id="masthead"]/span[contains(@class, "timestamp")]').text().trimInternal(),
publicationTitle : "The New Yorker",
ISSN: "0028-792X"
});
...
/** Search results */
 FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//div[@id="search-results"]/article'),
choices : {titles : FW.Xpath('//div[@id="search-results"]/article//h2/a').text(),
urls : FW.Xpath('//div[@id="search-results"]/article//h2/a').key('href').text() }
});
