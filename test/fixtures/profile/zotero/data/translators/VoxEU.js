{
	...
	"lastUpdated": "2016-06-12 15:43:49"
}
...
creators : FW.Xpath('//div[contains(@class, "vox-author-info")]//span[@class="field-content"]/a').text().cleanAuthor("author"),
abstractNote : FW.Xpath('//div[@class="article-teaser"]').text(),
date : FW.Xpath('//span[@class="date-display-single"]').text(),
...
var testCases = [
	{
		"type": "web",
		"url": "http://voxeu.org/article/green-growth-evidence-energy-taxes-europe",
		"items": [
			{
				"itemType": "blogPost",
