...
/*
   dhistory Archives Viewer Translator
   Copyright (C) 2012 Tim Sherratt
...
FW.Scraper({
itemType         : 'manuscript',
detect           : FW.Url().match(/\/archives\/naa\/items\/\d+\/\d+/),
title            : FW.Xpath('//h2').text(),
shortTitle       : FW.Xpath('//div[@about="#page"]/div[@property="bibo:locator"]/@content').text().prepend('NAA: '),
archiveLocation  : FW.Xpath('//div[@about="#page"]/div[starts-with(@property,"bibo:locator")]/@content').text(),
pages            : FW.Xpath('//h2/@data-page').text(),
archive          : FW.Xpath('//div[contains(@about,"#repository")]/div[@property="foaf:name"]/@content').text(),
manuscriptType   : 'folio',
libraryCatalog   : "dhistory Archives Viewer",
url              : FW.Url(),
attachments : [
  { url : FW.Xpath('//img[@id="page-image"]').key('src').text().append('large'),
	title: FW.Xpath('//div[@about="#page"]/div[@property="bibo:locator"]/@content').text().prepend('Digital copy of NAA: '),
	type : "image/jpeg" }
  ]
});
...
var testCases = [
	{
		"type": "web",
		"url": "http://dhistory.org/archives/naa/items/3445411/",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "http://dhistory.org/archives/naa/items/3445411/3/",
		"items": [
			{
				"itemType": "manuscript",
				"creators": [],
				...
				"attachments": [
					{
						"url": "http://dhistory.org/archives/naa/images/3445411/3/large",
						"title": "Digital copy of NAA: B2455, WRAGGE C L E, page 3",
						"type": "image/jpeg"
					}
				],
				"url": "http://dhistory.org/archives/naa/items/3445411/3/",
				"archive": "National Archives of Australia",
				"archiveLocation": "B2455, WRAGGE C L E, page 3",
				"libraryCatalog": "dhistory Archives Viewer",
				"manuscriptType": "folio",
				"pages": "3",
				"shortTitle": "NAA: B2455, WRAGGE C L E, page 3",
				"title": "National Archives of Australia: B2455, WRAGGE C L E, page 3",
