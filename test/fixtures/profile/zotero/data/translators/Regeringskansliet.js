...
FW.Scraper({
itemType		: 'bill',
detect			: FW.Xpath('//dl[@class="definitions"]/dd[2]').text().match(/^(Lagrådsremiss|Proposition|Departementsserien|Statens|Kommittédirektiv)/),
language		: 'sv-SE',
url				: FW.Url(),
...
//attachments are numerous and often large, so we leave them commented out
/*attachments		: 
	[{
