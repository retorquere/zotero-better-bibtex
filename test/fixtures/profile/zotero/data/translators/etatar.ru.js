...
FW.Scraper({ itemType         : 'journalArticle',
			 ...
			 tags			  : FW.Xpath('//div[@class="post-tags"]/a[@rel="tag"]').text(),
			 attachments      : [
				{
					url :	FW.Url(),
					type :	"text/html",
					title: 	"eTatar.ru Snapshot"
				}],
			 creators         : FW.Xpath('//div[@class="post"]/strong[last()]').text().cleanAuthor("author"),
			 // This doesn't handle years before 2000 or after 2099
			 date             : FW.Xpath('//div[@class="containerI"]/div[@class="sitenav"]').text()
			 			.trimInternal()
			 			.replace(/.*([0-9]{2})\.([0-9]{2})\.([0-9]{2}).*/,'20$3-$2-$1'),
...
var testCases = [
	{
		"type": "web",
		"url": "http://etatar.ru/top/41079?utm_source=twitterfeed&utm_medium=twitter",
		"items": [
			{
				...
				"date": "2011-09-13",
				"publicationTitle": "eTatar.ru",
				"title": "В Казани всё спокойно: проблем с языками нет",
				"libraryCatalog": "etatar.ru",
				"accessDate": "CURRENT_TIMESTAMP",
				"shortTitle": "В Казани всё спокойно",
				"checkFields": "title"
			}
		]
	}
