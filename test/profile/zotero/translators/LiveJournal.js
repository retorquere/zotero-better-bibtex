{
	...
	"lastUpdated": "2012-06-30 10:25:12"
}
...
date            : FW.Xpath('//div[@class="asset-header-content-inner"]/div[contains(@class, "asset-meta")]//abbr')
					.text().remove(/at.*$/),
attachments      : [{ url: FW.Url(),
  title:  "LiveJournal Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//dd[@class="profile-username item"]/span[contains(@class, "ljuser")]/a/b').text().cleanAuthor("author"),
blogTitle         : FW.Xpath('//div[@id="header-name"]/a').text()
});

// http://shlyahtich.livejournal.com/ (Lanzelot design)
//the blog doesn't have 
FW.Scraper({
itemType         : "blogPost",
