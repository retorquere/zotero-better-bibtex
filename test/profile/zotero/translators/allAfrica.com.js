{
	...
	"translatorType": 4,
	"browserSupport": "gcsv",
	"lastUpdated": "2012-11-27 20:18:36"
}
...
title            : FW.Xpath('//div[@class="heading"]/h1').text().trim(),
...
date             : FW.Xpath('//cite[@class="byline"]').text().replace(/^.+,/,"").trim(),
tags             : FW.Xpath('//div[@class="heading"]/div[contains(@class, "tags")]//a').text().trim(),
...
choices          : {
  ...
  urls    :  FW.Xpath('//p[@class="title"]/a').key("href")
}
});
