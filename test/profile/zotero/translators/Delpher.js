{
	...
	"label": "Delpher",
	"creator": "Hieke Huistra, Thijs Kinkhorst",
	...
	"lastUpdated": "2014-03-29 16:29:24"
}
...
/*
   Delpher Translator
   Copyright (C) 2014 Hieke Huistra and Thijs Kinkhorst
...
FW.Scraper({
	detect		: FW.Url().match(/boeken\..*view\/index/),
	itemType	: "book",
	title		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/title:\s*(.*)<br\/>/, 1),
	creators	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/creator:\s*(.*)<br\/>/, 1).cleanAuthor("author", true),
	date		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/date:\s*(.*)<br\/>/, 1),
	publisher	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/publisher:\s*(.*)<br\/>/, 1),
	numPages	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/extent:\s*(.*)<br\/>/, 1),
	language	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/language:\s*(.*)<br\/>/, 1),
	url		: FW.Xpath("//div[@class='persistent-url']/input").key("value").text(),
	archive		: "Delpher, Koninklijke Bibliotheek, Den Haag",
...
FW.Scraper({
	detect		: FW.Url().match(/tijdschriften.*view\/index/),
	itemType	: "journalArticle",
	title		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/title:\s*(.*)<br\/>/, 1),
	publicationTitle: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/alternative:\s*(.*)<br\/>/, 1),
	volume		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/title:.*jrg\s*(\d+)/, 1),
	issue		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/issuenumber:\s*(.*)<br\/>/, 1),
	date		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/date:\s*(.*)<br\/>/, 1),
	language	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/language:\s*(.*)<br\/>/, 1),
	archive		: "Delpher, Koninklijke Bibliotheek, Den Haag",
	url		: FW.Xpath("//div[@class='persistent-url']/input").key("value").text(),
...
FW.Scraper({
	detect		: FW.Url().match(/kranten.*view\/index/),
	itemType	: "newspaperArticle",
	title		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/originalTitle:\s*(.*)<br\/>/, 1),
	publicationTitle: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/papertitle:\s*(.*)<br\/>/, 1),
	date		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/date:\s*(\d+\/\d+\/\d+)/, 1),
	edition		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/edition:\s*(.*)<br\/>/, 1),
	publisher	: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/publisher:\s*(.*)<br\/>/, 1),
	place		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/spatialCreation:\s*(.*)<br\/>/, 1),
	language	: "nl",
	pages		: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/pageurl:.*p0*(\d+)<br\/>/, 1),
	/*we used "pageurl:" instead of "page:", because the page number attached to "page:" is not always correct*/
	archive		: "Delpher, Koninklijke Bibliotheek, Den Haag",
	url		: FW.Xpath("//div[@class='persistent-url']/input").key("value").text(),
	attachments: [{
		url: FW.Xpath("//div[@class='viewer info hide']/noscript").text().match(/identifier:\s*(.*)<br\/>/, 1),
		title: "OCR",
		type: "text/html"
	}],
...
FW.Scraper({
	detect		: FW.Url().match(/radiobulletins.*view\/index/),
...
FW.MultiScraper({
	itemType	: "multiple",
	detect		: FW.Url().match(/results\/index/),
	choices: {
		titles: FW.Xpath("//div[@class='mdfields']/h3/a").text(),
		urls: FW.Xpath("//div[@class='mdfields']/h3/a").key("href").text()
	}
...
var testCases = [{
	...
	"type": "web",
	"url": "http://boeken.delpher.nl/nl/view/index?query=buurman&coll=boeken&image=dpo:2390:mpeg21:0012&page=1&maxperpage=10",
	"items": [{
		"itemType": "book",
		"creators": [{
		...
		"seeAlso": [],
		"attachments": [],
		"url": "http://resolver.kb.nl/resolve?urn=dpo:2390:mpeg21:0012",
		"archive": "Delpher, Koninklijke Bibliotheek, Den Haag",
		"date": "1796",
		"language": "nederlands; dut; dutch; flemish; néerlandais; flamand",
		"numPages": "72",
	...
	"type": "web",
	"url": "http://kranten.delpher.nl/nl/view/index?query=buurman&coll=ddd&image=ddd%3A110578678%3Ampeg21%3Aa0106&page=1&maxperpage=10",
	"items": [{
		"itemType": "newspaperArticle",
		"creators": [],
		"notes": [],
		...
		"url": "http://resolver.kb.nl/resolve?urn=ddd:110578678:mpeg21:a0106",
		"archive": "Delpher, Koninklijke Bibliotheek, Den Haag",
		"date": "1941/02/01",
		"edition": "Avond",
		"language": "nl",
	...
	"type": "web",
	"url": "http://radiobulletins.delpher.nl/nl/view/index?query=buurman&coll=anp&image=anp%3A1950%3A02%3A20%3A19%3Ampeg21&page=1&maxperpage=10",
	"items": [{
		"itemType": "radioBroadcast",
		"creators": [],
		"notes": [],
	...
	"type": "web",
	"url": "http://tijdschriften.delpher.nl/nl/view/index?query=buurman&coll=dts&image=dts:2738036:mpeg21:0012&page=1&maxperpage=10#info",
	"items": [{
		"itemType": "journalArticle",
		"creators": [],
		"notes": [],
		...
		"seeAlso": [],
		"attachments": [],
		"url": "http://resolver.kb.nl/resolve?urn=dts:2738036:mpeg21:0012",
		"archive": "Delpher, Koninklijke Bibliotheek, Den Haag",
		"date": "1924-05-02",
		"issue": "35",
		"language": "dut",
