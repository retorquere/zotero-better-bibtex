{
	...
	"target": "^https?://(www|search)\\.huffingtonpost\\.com",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 4,
	"browserSupport": "gcsv",
	"lastUpdated": "2014-02-24 00:25:56"
}
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//h1[@class="title-news"]|//h1[@class="title-news entry-title"]|//article[@class="entry"]//h1[@class="title"]'),
title            : FW.Xpath('//h1[@class="title-news"]|//h1[@class="title-news entry-title"]|//article[@class="entry"]//h1[@class="title"]').text().trim(),
attachments      : [{ url: FW.Url().replace(/\?.+/, "").append("?view=print&comm_ref=false"),
  title:  "Huffington Post",
  type: "text/html" }],

creators         : FW.Xpath('//a[@rel="author"]').text().cleanAuthor("author"),
date             : FW.Xpath('//span[@class="posted-and-updated"]|//span[@class="posted"]/time').text().match(/\d{2}\/\d{2}\/\d{2,4}/),
//tags             : FW.Xpath('//meta[@name="keywords"]/@content').text().split(/,/),
...
FW.Scraper({
itemType         : 'blogPost',
detect           : FW.Xpath('//h1[@class="title-blog"]'),
title            : FW.Xpath('//h1[@class="title-blog"]').text().trim(),
attachments      : [{ url: FW.Url().replace(/\?.+/, "").append("?view=print&comm_ref=false"),
  title:  "Huffington Post",
  type: "text/html" }],

creators         : FW.Xpath('//a[@rel="author"]').text().cleanAuthor("author"),
date             : FW.Xpath('//meta[@name="sailthru.date"]/@content').text().replace(/^.+,/, ""),
//tags             : FW.Xpath('//meta[@name="keywords"]/@content').text().split(/,/),
abstractNote     : FW.Xpath('//meta[@name="description"]/@content').text(),
publicationTitle : "Huffington Post"
});
...
FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Url().match(/huffingtonpost.com\/search\.php/),
choices          : {
  titles :  FW.Xpath('//div[@class="gs-title"]/a[contains(@href, ".html")]').text().trim(),
  urls    :  FW.Xpath('//div[@class="gs-title"]/a[contains(@href, ".html")]').key("href")
}
});

FW.MultiScraper({
itemType         : 'multiple',
detect           : FW.Xpath('//h4/a/@href'),
choices          : {
...
var testCases = [
		...
		"items": [
			{
				...
				"url": "http://www.huffingtonpost.com/dan-solin/their-confidence-is-killi_b_1112953.html?ref=business",
				"abstractNote": "I often wonder why so many investors ignore the overwhelming data indicating that capturing market returns in a globally diversified portfolio of low management fee index funds in a suitable asset allocation is likely to outperform stock picking, manager picking and market timing.",
				"date": "29 Nov 2011 19:53:32 -0500",
				"publicationTitle": "Huffington Post",
		...
		"items": [
			{
				...
				"url": "http://www.huffingtonpost.com/2011/11/28/prepaid-cards_n_1117226.html?ref=business",
				"abstractNote": "In the latest signal that the economic crisis has fundamentally changed the way Americans handle their money, the largest provider of prepaid debit cards is now buying a bank. GreenDot Corp. got the go-ahead last week from the Federal Reserve Board to purchase Bonneville Bancorp in Provo, Utah, for $15.7 million, marking the first time a prepaid card company has won approval to buy a bank.",
				"date": "11/29/11",
				"publicationTitle": "Huffington Post",
	...
	{
		"type": "web",
		"url": "http://www.huffingtonpost.com/search.php/?q=labor+market&s_it=header_form_v1",
		"items": "multiple"
	}
]
/** END TEST CASES **/