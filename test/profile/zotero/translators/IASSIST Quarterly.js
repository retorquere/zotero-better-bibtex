{
	"translatorID": "ac721d14-f081-4613-91e8-255c22ad05eb",
	"label": "IASSIST Quarterly",
	"creator": "Sebastian Karcher",
	"target": "^https?://www\\.iassistdata\\.org/iq/",
	"minVersion": "2.1.9",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
...
/** IASSIST Quarterly Translator
	Copyright (c) 2012 Sebastian Karcher
	Developed as part of the 2012 Zotero Trainer Workshop in Ann Arbor, MI
...
FW.MultiScraper({
itemType : "multiple",
detect : FW.Xpath('//span[@class="views-field-title"]/span/a'),
choices : {
  titles : FW.Xpath('//span[@class="views-field-title"]/span/a').text(),
  urls : FW.Xpath('//span[@class="views-field-title"]/span/a').key('href').text()
}
});
...
detect : FW.Xpath('//h1[@class="title"]'),
title : FW.Xpath('//h1[@class="title"]').text().trim(),
attachments : {
  url : FW.Xpath('//div[@class="filefield-file"]/a/@href').text(),
  title : "IASSIST Quarterly PDF",
  type : "application/pdf"
},
creators : FW.Xpath('//div[@class="field-label" and contains(text(), "Author")]/following-sibling::div').text().split(/,/).cleanAuthor("author"),
abstractNote : FW.Xpath('//div[@class="article-teaser"]').text(),
date : FW.Xpath('//div[@class="field-label" and contains(text(), "Volume")]/following-sibling::div').text(),
volume : FW.Xpath('//div[@class="field-label" and contains(text(), "Volume")]/following-sibling::div').text(),
pages: FW.Xpath('//div[@class="field-label" and contains(text(), "Page")]/following-sibling::div').text(),
issue : FW.Xpath('//div[@class="field-label" and contains(text(), "Issue")]/following-sibling::div').text(),
...
var testCases = [
	{
		"type": "web",
		"url": "http://www.iassistdata.org/iq/issue/35/4",
		"items": "multiple"
	},
	{
		"type": "web",
		"url": "http://www.iassistdata.org/iq/examination-data-deposit-practices-repositories-oais-model",
		"items": [
			{
				"itemType": "magazineArticle",
				"creators": [
				...
				"volume": "2011",
				"libraryCatalog": "IASSIST Quarterly",
