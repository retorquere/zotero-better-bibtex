{
	...
	"lastUpdated": "2013-12-09 17:47:50"
}
...
detect           : FW.Xpath('//div[@class="articleContentBox"]//h1'),
title            : FW.Xpath('//div[@class="articleContentBox"]//h1').text().trim(),
attachments      : [{ url: FW.Url().replace(/node/,"print"),
  title:  "Business Standard India Snapshot",
  type: "text/html" }],
creators         : FW.Xpath('//div[contains(@class, "byline")]/strong[1]').text().trimInternal().remove(/\|\n?.+/g).cleanAuthor("author"),
date             : FW.Xpath('//div[contains(@class, "byline")]//strong[@itemprop="datePublished"]/@content').text(),
...
choices          : {
  titles :  FW.Xpath('//div[contains(@class, "article")]/h2/a').text().trim(),
  urls    :  FW.Xpath('//div[contains(@class, "article")]/h2/a').key("href")
}
});/** BEGIN TEST CASES **/
var testCases = [
	{
