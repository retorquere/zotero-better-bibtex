{
	...
	"target": "^https?://(www|search.?)?\\.bloomberg(view)?\\.com",
	"minVersion": "2.1.9",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2014-03-01 09:53:32"
}
...
title            : FW.Xpath('//h1[contains(@class, "article_title")]').text().trim(),
...
FW.Scraper({
itemType         : 'webpage',
detect           : FW.Xpath('//h1[@class="headline"]'),
...
var testCases = [
	{
		"type": "web",
		"url": "http://search1.bloomberg.com/search/?content_type=all&page=1&q=argentina",
		"items": "multiple"
	},
	{
		"type": "web",
