  ...
  constructor() {
    ...
    for (const tab of this.tabs) {
      ...
      for (const pref of Object.values(this.preferences)) {
        ...
        docs.push(`default: \`${pref.default}\``)
        docs.push(pref.description)
      }
    }
    ...
    for (const pref of Object.values(this.preferences)) {
      ...
      docs.push(`### ${pref.preference.replace(prefix, '')}`)
      docs.push(`default: \`${pref.default}\``)
      docs.push(pref.description)
    }

    fs.writeFileSync(path.join(__dirname, '../../wiki/Configuration.md'), docs.join('\n\n'))
  }
