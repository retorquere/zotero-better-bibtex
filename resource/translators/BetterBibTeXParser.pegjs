...
string
  ...
  / text:("\^\\circ")                                                  terminator     &{ return lookup(text, '9'); }{ return lookup(text); }
  / text:("\\" [=kr] "{" [a-zA-Z] "}")                                                &{ return lookup(text, '10'); }{ return lookup(text); }
  / text:("\\" [\.~\^'`"] "{" [a-zA-Z] "}")                                           &{ return lookup(text, '11'); }{ return lookup(text); }
  / text:("\\u \\i")                                                   terminator     &{ return lookup(text, '12'); }{ return lookup(text); }
  / text:("''" +)                                                                     &{ return lookup(text, '13'); }{ return lookup(text); }
  / text:("\\" [Huvc] " " [a-zA-Z])                                    terminator     &{ return lookup(text, '14'); }{ return lookup(text); }
  / text:("\\" [~\^'`"] "\\" [ij])                                     terminator     &{ return lookup(text, '15'); }{ return lookup(text); }
  / text:("\\" [~\^'`"][a-zA-Z])                                       terminator     &{ return lookup(text, '16'); }{ return lookup(text); }
  / text:("\\" [\.=][a-zA-Z])                                          terminator     &{ return lookup(text, '17'); }{ return lookup(text); }
  / text:("\\" [^a-zA-Z0-9])                                                          &{ return lookup(text, '18'); }{ return lookup(text); }
  / text:("\^" [123])                                                  terminator     &{ return lookup(text, '19'); }{ return lookup(text); }
  / text:("~")                                                                        &{ return lookup(text, '20'); }{ return lookup(text); }
  / text:("\\ddot{\\" [a-z]+ "}")                                                     &{ return lookup(text, '21'); }{ return lookup(text); }
  / text:("\\" [a-z]+ "\\" [a-zA-Z]+)                                  terminator     &{ return lookup(text, '22'); }{ return lookup(text); }
  / text:("\\fontencoding{" [^}]+ "}\\selectfont\\char" [0-9]+)        terminator     &{ return lookup(text, '23'); }{ return lookup(text); }
